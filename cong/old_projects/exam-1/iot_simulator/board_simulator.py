...
class BoardSimulator:
    ...
    def __init__(self, name, mac_address, board_type, sensors=None):
        ...
        # register topic
        self.send_authenticate_topic = 'iot/authenticate'
        self.subcribe_topic = 'icse/'+"5C:3B:1A:16:2A"+'/action'
    ...
    def authenticate_with_server(self):
        ...
        for k in range(0, 3):
            self.mqtt_client.publish('icse/newDevice', json.dumps(authentication_info))
